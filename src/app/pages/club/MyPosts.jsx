...
export default function MyPosts() {
    const [posts, setPosts] = useState(mockPosts.filter((p) => p.clubId === "1"));
    ...
    return (<DashboardLayout role="club" userName="IEEE KFUPM Student Branch" userLogo="🔧" sidebarItems={sidebarItems}>
      <div className="space-y-6">
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    {post.isPinned && (<Badge variant="default">
        ...
        {posts.length === 0 && (<Card className="p-12 text-center">
            <FileText className="w-12 h-12 mx-auto mb-4 text-muted-foreground"/>
            <h3 className="text-xl font-semibold mb-2">No posts yet</h3>
            <p className="text-muted-foreground mb-4">
              Start sharing updates and announcements with your followers
            </p>
            <Link to="/club/posts/new">
