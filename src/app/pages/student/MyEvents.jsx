  ...
  if (logoUrl) {
    return (
      <img
        src={logoUrl}
        alt={name}
        className="w-10 h-10 rounded-full object-cover bg-[var(--card)]"
      />
    );
  }

  return (
    <div className="w-10 h-10 bg-[var(--card)] text-[var(--primary)] rounded-full flex items-center justify-center text-sm font-semibold">
